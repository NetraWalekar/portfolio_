           ...
           <div className='hero-container'>
            <div>
                ...
                <div className='social-icon'>
                   <svg style={{backgroundColor:'white',borderRadius:25,border:'2px solid black'}} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 24 24">
